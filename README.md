...
This repository republishes <https://github.com/googleads/googleads-mobile-ios-mediation-ironsource.git> tag `9.5.00000` with a
...
(`9.5.00000`) and use the same product names as upstream
